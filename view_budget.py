...
def page_budget(meta: pd.DataFrame, engine, f: Dict) -> None:
    ...
    with tab_alert:
        if alert_view.empty:
            ...
            # ✨ [NEW] 표 내부에 직접 눈에 띄게 경고 배경색(빨강, 주황)을 입히는 함수 (유지)
            def color_alert(val):
