diff --git a/view_budget.py b/view_budget.py
index 7f035ce78ba28e5574c88e56d3604a91236ad36d..0726a63225f0870805d2388a3b785629277b72eb 100644
--- a/view_budget.py
+++ b/view_budget.py
@@ -1,55 +1,54 @@
 # -*- coding: utf-8 -*-
...
+    end_dt = f.get("end") or (date.today() - timedelta(days=1))
...
+    bundle = query_budget_bundle(engine, cids, avg_d1, avg_d2, month_d1, month_d2, TOPUP_AVG_DAYS)
...
@@ -126,85 +125,85 @@ def page_budget(meta: pd.DataFrame, engine, f: Dict) -> None:
...
+            st.markdown("<div style='font-size:14px; font-weight:700; margin-bottom:12px; margin-top:20px;'>비즈머니 잔액 및 소진 예상</div>", unsafe_allow_html=True)
